...
const AllRooms = () => {
  ...
  return (
    <div
      className="flex flex-col-reverse lg:flex-row items-start justify-between gap-8 pt-28
    md:pt-35 px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32"
    >
      <div className="w-full min-w-0">
        ...
        {filteredRooms.length === 0 ? (
          ...
          filteredRooms.map((room) => (
            <div
              key={room._id}
              className="flex flex-col md:flex-row items-start py-8 md:py-10 gap-5 md:gap-6 border-b border-gray-300 last:pb-20 md:last:pb-30 last:border-0"
            >
              <img
                onClick={() => {
                ...
                className="h-56 sm:h-72 md:h-64 w-full md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer"
              />
              <div className="md:w-1/2 flex flex-col gap-2">
                ...
                <div className="flex flex-wrap items-center mt-3 mb-5 md:mb-6 gap-3 md:gap-4">
      ...
      <div className="bg-white w-full lg:w-80 lg:shrink-0 border border-gray-300 text-gray-600 max-lg:mb-4 lg:mt-16">
        <div

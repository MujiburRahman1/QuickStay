...
const Testimonial = () => {
  return (
    <div className="flex flex-col items-center px-4 sm:px-6 md:px-16 lg:px-24 bg-slate pt-16 md:pt-20 pb-20 md:pb-30">
      <Title
        title="What Our Guests Say"
        subTitle="Discover why discerning travelers 
      consistently choose QuickStay for their exclusive and luxurious accommodations around the world."
      />

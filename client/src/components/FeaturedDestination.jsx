...
const FeaturedDestination = () => {
  ...
  return validRooms.length > 0 && (
    <div className="flex flex-col items-center px-4 sm:px-6 md:px-16 lg:px-24 bg-slate-50 py-16 md:py-20">
      <Title
      ...
      />
      <div className="grid w-full grid-cols-1 gap-6 mt-12 sm:grid-cols-2 lg:grid-cols-4">
